...
@Mod(BioLogic.MODID)
public class BioLogic {
    public static final String MODID = "biologic";
    ...
    public static final DeferredRegister.ModItems ITEMS = DeferredRegister.createItems(MODID);
    ...
    public BioLogic(IEventBus modEventBus, ModContainer modContainer)
    {
        ...
        // Note that this is necessary if and only if we want *this* class (BioLogic) to respond directly to events.
